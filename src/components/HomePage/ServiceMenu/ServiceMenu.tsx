        ...
        <div className={styles.container}>
            ...
            <div className={styles.service}>
                <div className={styles.service_title}>
                    ...
                    <Link className={styles.service_title_name} href={`http://localhost:3000/catalog`}>Соберите своего монстра или выберите из имеющихся!</Link>
                </div>
            ...
            <div className={styles.service}>
                <div className={styles.service_title}>
                    ...
                    <Link className={styles.service_title_name} href={`http://localhost:3000/catalog`}>Апгрейд. Вдохните Новую Жизнь в Ваш Компьютер!</Link>
                </div>
                <div className={styles.service_description}>
            ...
            <div className={styles.service}>
                <div className={styles.service_title}>
                    ...
                    <Link className={styles.service_title_name} href={`http://localhost:3000/catalog`}>Ремонт и Диагностика. Быстрая и Профессиональная Помощь!</Link>
                </div>
                <div className={styles.service_description}>
                    Ищете идеальные комплектующие для своего компьютера или мечтаете о новом устройстве? Добро пожаловать в наш отдел продаж комплектующих и компьютеров! У нас вы найдете широкий ассортимент качественных компонентов: мощные процессоры, передовые видеокарты, быстрые накопители и многое другое. Если вы хотите обновить старое устройство, наши эксперты помогут вам выбрать оптимальные детали. А если вы готовы к новому компьютеру, мы предлагаем разнообразные модели для всех целей: от игр до работы.
                </div>
            ...
            <div className={styles.service}>
                <div className={styles.service_title}>
                    ...
                    <Link className={styles.service_title_name} href={`http://localhost:3000/catalog`}>Конфигуратор. Ваш верный помошник при сборе ПК!</Link>
                </div>
                <div className={styles.service_description}>
